...
*/
let [item1, item2, ...rest] = [3, 7, 15, 3 + 7, 7 + 15, 3 + 15, "end"];  // Переменная rest является массивом из оставшихся элементов.
...
// a = 2;
// a = 3;
// testType1 = 'functional';
// testType1 = 'Bob';
let [testType1 = 'functional', testType2 = 'non-functional', testType3 = console.log("I do't know."), testType4] = ["Bob", calculate(2,4), , console.log(calculate(2,4))];
...
[testType1 = console.log('functional'), testType2 = console.log('non-functional'), testType3 = console.log("I do't know."), testType4 = console.log(4)] = [];

console.log(`${testType1}, ${testType2}, ${testType3}, ${testType4}.`);  

[testType1 = calculate(1,1), testType2 = console.log("I do't know."), testType3 = console.log(calculate(3,3)), testType4 = console.log(calculate(4,4))] = [];

...
count2 = 0;
console.log(recursiveBinarySearch(array, 70));
...
console.log('Ищем "j": ', letters.sort());
...
function binarySearchWord(array, target) {
  let left = 0;
...
const index = binarySearchWord(sortedWords, targetWord);
